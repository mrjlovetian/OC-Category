...
Pod::Spec.new do |s|
  s.name             = 'OC-Category'
  s.version          = '0.1.0'
  s.summary          = 'A short description of OC-Category.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/OC-Category'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '房产销冠' => 'mrjyuhongjianglovetian@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/OC-Category.git', :tag => s.version.to_s }
